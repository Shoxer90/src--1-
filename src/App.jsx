      ...
      {!isBasketOrderPublicView && (! isLogin  && !localStorage.getItem("token")?
        ...
        <>
          ...
          {!isBlockedUser  && user ? <Routes>
            ...
            <Route path="/excelUpdate" element={<PasteExcelToReact logOutFunc={logOutFunc} setCurrentPage={setCurrentPage} />} />
            ...
            <Route
              ...
              element={<InVoiceMainDialog 
                ...
                setBasketContent={setBasketContent}
                loadBasket={loadBasket}
                setBasketGoodsqty={setBasketGoodsqty}
